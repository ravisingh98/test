...
abstract class BaseAdminPeer {
	...
	const IS_SUPERADMIN = 'admin.IS_SUPERADMIN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Level', 'IsSuperadmin', ),
		BasePeer::TYPE_COLNAME => array (AdminPeer::ID, AdminPeer::USERNAME, AdminPeer::PASSWORD, AdminPeer::LEVEL, AdminPeer::IS_SUPERADMIN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'level', 'is_superadmin', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Level' => 3, 'IsSuperadmin' => 4, ),
		BasePeer::TYPE_COLNAME => array (AdminPeer::ID => 0, AdminPeer::USERNAME => 1, AdminPeer::PASSWORD => 2, AdminPeer::LEVEL => 3, AdminPeer::IS_SUPERADMIN => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'level' => 3, 'is_superadmin' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AdminPeer::LEVEL);

		$criteria->addSelectColumn(AdminPeer::IS_SUPERADMIN);
