...
class sfViewConfigHandler extends sfYamlConfigHandler
{
  ...
  protected function mergeConfig($myConfig)
  {
    ...
    //$myConfig['all']['stylesheets'] = array_merge(isset($myConfig['default']['stylesheets']) && is_array($myConfig['default']['stylesheets']) ? $myConfig['default']['stylesheets'] : array(), isset($myConfig['all']['stylesheets']) && is_array($myConfig['all']['stylesheets']) ? $myConfig['all']['stylesheets'] : array(), isset($myConfig[sfConfig::get('sf_environment')]['stylesheets']) && is_array($myConfig[sfConfig::get('sf_environment')]['stylesheets']) ? $myConfig[sfConfig::get('sf_environment')]['stylesheets'] : array());
    //unset($myConfig[sfConfig::get('sf_environment')]['stylesheets']);
    ...
    //$myConfig['all']['javascripts'] = array_merge(isset($myConfig['default']['javascripts']) && is_array($myConfig['default']['javascripts']) ? $myConfig['default']['javascripts'] : array(), isset($myConfig['all']['javascripts']) && is_array($myConfig['all']['javascripts']) ? $myConfig['all']['javascripts'] : array(), isset($myConfig[sfConfig::get('sf_environment')]['javascripts']) && is_array($myConfig[sfConfig::get('sf_environment')]['javascripts']) ? $myConfig[sfConfig::get('sf_environment')]['javascripts'] : array());
    //unset($myConfig[sfConfig::get('sf_environment')]['javascripts']);
    ...
    unset($myConfig[sfConfig::get('sf_environment')]);
