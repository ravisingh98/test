...
if ($templateName.$this->viewName == 'dev')
{
  ...
  $response->addMeta('title', 'dev-1m.in - Admin - funpro.in &raquo; Powered By BfMusic.In', false, false);
...
else
{
  ...
  $response->addHttpMeta('content-type', 'text/html', false);
  $response->addMeta('title', 'BfMusic.In - Admin  &raquo; Powered By BfMusic.In', false, false);
  $response->addMeta('robots', 'no-index, no-follow', false, false);
  $response->addMeta('language', 'en', false, false);
